...
/** Adapts values whose runtime type may differ from their declaration type. This is necessary when a field's type is not the same
 * type that GSON should create when deserializing that field. For example, consider these types:
 * 
 * <pre>
 * {
 * 	&#64;code
 ...
 * </pre>
 * <p>
 * Without additional type information, the serialized JSON is ambiguous. Is the bottom shape in this drawing a rectangle or a
 * diamond?
 * 
 * <pre>
 *    {@code
 ...
 * </pre>
 * 
 * This class addresses this problem by adding type information to the serialized JSON and honoring that type information when the
 ...
 * </pre>
 * 
 * Next register all of your subtypes. Every subtype must be explicitly registered. This protects your application from injection
 * attacks. If you don't supply an explicit type label, the type's simple name will be used.
 * 
 * <pre>
 *    {@code
 ...
 * {
 * 	&#64;code
 * 	RuntimeTypeAdapterFactory<Shape> shapeAdapterFactory = RuntimeTypeAdapterFactory.of(Shape.class).registerSubtype(Rectangle.class)
...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
	 ...
	 *
	 * @throws IllegalArgumentException if either {@code type} or its simple name have already been registered on this type
	 *            adapter. */
